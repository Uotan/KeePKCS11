...
В текущей версии плагин может создавать ключевые объекты фиксированной длинны (32 символа) с энтропией ≈135.71. Для создания используется функция *Random()*, что не безопасно. Недочет будет исправлен к следующей версии.
